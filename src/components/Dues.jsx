export default function Dues() {
  return (<div>
      ...
      <h3 className="item__subtitle">
                  СРОК ОПЛАТЫ И РАЗМЕР ВЗНОСОВ 2023 г.
                </h3>
                <p className="text">
                  Срок оплаты установлен не позднее 30.06.2023 г. Сумма 800,00
                  руб. за одну сотку членский взнос, 200,00 руб. за одну сотку
                  целевой взнос. Всего за участок 6 соток сумма взносов 6 000,00
                  руб.
                </p>
                <p  className="text">
                ...
                <div className="dues__wrapper">
                <h3 className="item__subtitle">
                  СРОК ОПЛАТЫ И РАЗМЕР ВЗНОСОВ 2024 г.
                </h3>
                <p className="text">
                  Срок оплаты установлен не позднее 01.05.2024 г. Сумма 740,00
                  руб. за одну сотку членский взнос, 260,00 руб. за одну сотку
                  целевой взнос. Всего за участок 6 соток сумма взносов 6 000,00
                  руб.</p> <p  className="text">Протокол очередного общего собрания членов СНТ
                  «РАДАР» от 28.10.2023 г.
                </p>
                </div>
    </div>
  </div>);
