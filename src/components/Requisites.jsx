  ...
  return (
    <div className="requisites">
      <ul className="requisites__list">
        ...
        <li className="requisites__item">
          236004, Калининградская область, г. Калининград, ул. Водная, д. 10
        </li>
        <li className="requisites__item_imp">Телефон/факс</li>
        <li className="requisites__item">+7 921 612 79 21</li>
        ...
        <li className="requisites__item_imp">
          Основной вид деятельности ОКВЭД
        </li>
        <li className="requisites__item">
          68.32.2 Управление эксплуатацией нежилого фонда за вознаграждение или
          на договорной основе
        </li>
        <li className="requisites__item_imp">Председатель</li>
        <li className="requisites__item">
          Колотилин Дмитрий Владимирович. Действует на основании Устава от
          29.10.2022 г.
        </li>
        <li className="requisites__item_imp">E-mail:</li>
        <li className="requisites__item">kolotilin_dv@mail.ru</li>
      </ul>
    </div>
  );
}
